package am.aca.AddressBook.comman.resource;
...
public class StaticVariables {
    ...
    public String writeFriendUsername = "Please provide your friend username";
    public String addOrShow = "Your friend added in list, input 'Show' if you want to see friend list or 'Add' to add again";
}
